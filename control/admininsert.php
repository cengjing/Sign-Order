...
if (!mysql_query($sql,$conn))
  ...
  die('Error: ' . mysql_error());
	  ...
	  echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><script language='javascript'>alert('发货成功！');location='../index.php';</script><center>已发货{$id}的订单！</center>";
