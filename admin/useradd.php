...
mysql_query('set names utf8');//设置插入数据库的字符集格式，避免数据库中的数据出现乱码
...
echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><script language='javascript'>alert('提交成功！');location='../admin/main.php';</script>";
